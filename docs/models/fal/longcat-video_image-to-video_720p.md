...
# longcat-video_image-to-video_720p`
...
- **Endpoint**: `https://fal.run/fal-ai/longcat-video/image-to-video/720p`
- **Model ID**: `fal-ai/longcat-video/image-to-video/720p`
...
- **`num_refine_inference_steps`** (`integer`, _optional_):
...
```bash
curl --request POST \
  --url https://fal.run/fal-ai/longcat-video/image-to-video/720p \
...
const result = await fal.subscribe("fal-ai/longcat-video/image-to-video/720p", {
  input: {
    image_url: "https://v3b.fal.media/files/b/zebra/trXRsbjJwy4Z3OEgbnB9a.jpg"
  },
  logs: true,
...
- [Model Playground](https://fal.ai/models/fal-ai/longcat-video/image-to-video/720p)
- [API Documentation](https://fal.ai/models/fal-ai/longcat-video/image-to-video/720p/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/longcat-video/image-to-video/720p)
