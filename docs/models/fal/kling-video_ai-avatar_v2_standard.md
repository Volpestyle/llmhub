...
- **Endpoint**: `https://fal.run/fal-ai/kling-video/ai-avatar/v2/standard`
- **Model ID**: `fal-ai/kling-video/ai-avatar/v2/standard`
...
- [Model Playground](https://fal.ai/models/fal-ai/kling-video/ai-avatar/v2/standard)
- [API Documentation](https://fal.ai/models/fal-ai/kling-video/ai-avatar/v2/standard/api)
- [OpenAPI Schema](https://fal.ai/api/openapi/queue/openapi.json?endpoint_id=fal-ai/kling-video/ai-avatar/v2/standard)
